...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, NzFormModule, NzInputModule, NzInputNumberModule, NzSelectModule, NzRadioModule, NzButtonModule],
})
export class CreateTransactionPage implements OnInit {
  ...
  submit() {
    ...
    this.transactionService.createTransaction(this.projectId, transaction).subscribe({
      next: (response) => {
